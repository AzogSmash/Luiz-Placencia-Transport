export const metadata = { title: 'Política de privacidad — Luiz Placencia Transport' }
    ...
    <main className="page-enter" style={{ padding: '64px 0 96px' }}>
      <div className="container" style={{ maxWidth: 760 }}>
        ...
        <Section title="Destinatarios">
          <p>
            Sus datos son tratados exclusivamente por Luiz Placencia Transport y no se ceden a terceros,
